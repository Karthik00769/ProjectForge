          ...
          >
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Enter your credentials to access ProjectForge</CardDescription>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <Link href="/auth/forgot-password" title="Reset your password" className="text-sm text-primary hover:underline transition">Forgot password?</Link>
                    </div>
                  ...
                  <Button type="button" variant="outline" className="w-full bg-transparent" disabled={isLoading} onClick={handleGoogleSignIn}>
