// Template configuration with predefined steps
...
export const TEMPLATE_CATEGORIES = [
  {
    category: "Business & Client Delivery",
    description: "For project deliverables, invoicing, and client work",
    icon: "Briefcase",
    color: "text-green-600",
  },
  {
    category: "Skilled & Field Work",
    description: "Perfect for trades, installations, and manual work",
    icon: "Zap",
    color: "text-orange-600",
  },
  {
    category: "Freelancers & Creators",
    description: "For creative projects and design work",
    icon: "Briefcase",
    color: "text-purple-600",
  },
  {
    category: "Construction & Infrastructure",
    description: "For construction phases and site inspections",
    icon: "Zap",
    color: "text-yellow-600",
  },
  {
    category: "Sales / Operations / Office Work",
    description: "For sales, operations, and office tasks",
    icon: "Briefcase",
    color: "text-blue-600",
  },
  {
    category: "General Purpose",
    description: "Flexible templates for any task type",
    icon: "Zap",
    color: "text-gray-600",
  },
]
